...
open(ofilename, "w") do io
    write(io, HTTP.get("https://psl.noaa.gov/data/correlation/oni.data").body)
end
...
oni = CSV.read("data/ONI_data.csv", DataFrame)
...
![Global Temperature Anomalies](data/Global_Temperature_Anomalies.png){width="100%"}
:::

::: {.content-visible unless-format="html"}
![Global Temperature Anomalies](data/Global_Temperature_Anomalies.pdf){width="100%"}
:::
...
::: {.content-visible when-format="html"}
![Global Temperature Anomalies (Last 30 Years)](data/Global_Temperature_Anomalies_Last_30_Years.png){width="100%"}
:::

::: {.content-visible unless-format="html"}
![Global Temperature Anomalies (Last 30 Years)](data/Global_Temperature_Anomalies_Last_30_Years.pdf){width="100%"}
:::
...
::: {.content-visible when-format="html"}
![Global Temperature Anomalies with ENSO Phases](data/Global_Temperature_Anomalies_Last_30_Years_ONI.png){width="100%"}
:::

::: {.content-visible unless-format="html"}
![Global Temperature Anomalies with ENSO Phases](data/Global_Temperature_Anomalies_Last_30_Years_ONI.pdf){width="100%"}
:::
