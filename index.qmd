...
Note that the url changes every month as new data is added. The code below uses the latest url as of November 2025 (`...202511.asc`). If the code does not work in the future, try updating the url using the latest year and month.

```{julia}
# Download the NOAAGlobalTemp temperature data 
# URL of the NOAAGlobalTemp global monthly average CSV ---yearmonth.asc
nurl = "https://www.ncei.noaa.gov/data/noaa-global-surface-temperature/v6/access/timeseries/aravg.mon.land_ocean.90S.90N.v6.0.0.202511.asc"
# Local filename to save
